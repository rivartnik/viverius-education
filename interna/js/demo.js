...
{ 
	this.editableGrid = new EditableGrid("razpisani_tecaji", {
      enableSort: true,
...
DatabaseGrid.prototype.fetchGrid = function()  {
	...
	this.editableGrid.loadJSON("loaddata.php?db_tablename=razpisani_tecaji");
};
...
DatabaseGrid.prototype.addRow = function(id) 
{
  ...
  var self = this;
		...
		data: {
			...
			DATUM:  $("#DATUM").val(),
			HOUR:  $("#HOUR").val(),
			ST_ODPRTIH_MEST:  $("#ST_ODPRTIH_MEST").val(),
			STATUS:  $("#STATUS").val(),
			VRSTA:  $("#VRSTA").val(),
			OPIS_TECAJA:  $("#OPIS_TECAJA").val()
		},
		success: function (response) 
		{ 
			if (response == "ok" ) {
