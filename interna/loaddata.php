...
$grid->addColumn('DATUM', 'Datum', 'date');  
$grid->addColumn('HOUR', 'Ura', 'hour');  
$grid->addColumn('STATUS', 'Status', 'string');  
$grid->addColumn('VRSTA', 'Vrsta', 'integer');  
$grid->addColumn('ST_ODPRTIH_MEST', 'Razpisana mesta', 'integer');                                               
$grid->addColumn('OPIS_TECAJA', 'Opis tečaja', 'string');  
$grid->addColumn('action', 'Action', 'html', NULL, false, 'id');  

$mydb_tablename = (isset($_GET['db_tablename'])) ? stripslashes($_GET['db_tablename']) : 'razpisani_tecaji';


error_log(print_r($_GET,true));

$query = 'SELECT *, date_format(DATUM, "%d/%m/%Y") as DATUM FROM '.$mydb_tablename ;
